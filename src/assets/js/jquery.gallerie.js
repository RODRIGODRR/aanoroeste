		...
		var methods = {
			...
			setImage: function(imageLink){
				return this.each(function(){
					...
					$imageLink.prop('href') != undefined ? preloadImage.src = $imageLink.prop('href') : null;
					...
					var thumbpos = $targetThumb.position() != undefined ? $targetThumb.position().left + $targetThumb.outerWidth(true)/2 : null,
						winwidth = $(window).width();
					
					if ($targetThumb.offset() != undefined ? $targetThumb.offset().left < 0 : null || thumbpos > winwidth) {
